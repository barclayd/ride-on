...
// RouteModel (SwiftData persistence) <-> RideOnCore.Route (platform-free
// scoring value type). The engine only needs the latter; RouteModel carries
// the raw geometry a `Route` doesn't (coordinates, bearing segments, import
// provenance).
